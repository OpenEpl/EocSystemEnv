...
if(NOT DEFINED EOC_BUILD_HELPER_INCLUDED)
	...
	function (target_link_eoc_lib ARG_TARGET ARG_INTERNAL_NAME ARG_RPOJECT_NAME)
		...
		if(DEFINED ${ARG_RPOJECT_NAME}_INCLUDE_DIRS)
			target_include_directories(${ARG_TARGET} PUBLIC ${${ARG_RPOJECT_NAME}_INCLUDE_DIRS})
		endif()
		if(DEFINED ${ARG_RPOJECT_NAME}_LIBRARIES)
			target_link_libraries(${ARG_TARGET} ${${ARG_RPOJECT_NAME}_LIBRARIES})
		else()
			target_link_libraries(${ARG_TARGET} ${ARG_RPOJECT_NAME})
		endif()
	endfunction ()
endif()